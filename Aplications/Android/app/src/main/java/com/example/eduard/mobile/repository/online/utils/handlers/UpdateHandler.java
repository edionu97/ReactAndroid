...
/**
 * Execute the call to server for updating an existing contact
 */
public class UpdateHandler extends NetworkHandler<String, Void, Pair<Integer, String>> {

    public UpdateHandler(Context context, OnSuccess success, boolean toastNotify) {
    ...
    protected Pair<Integer, String> doInBackground(String... strings) {
        ...
        try {
            ...
            // prepare connection
            String url = Config.getInstance().getComposed(context.get(), "server-address", "update-contact-url");
